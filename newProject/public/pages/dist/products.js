...
function renderProducts(productContainer) {
    return __awaiter(this, void 0, void 0, function () {
        var response, products, productHTML, error_1;
...
function handleAddproduct(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var product, response, _a, error, productDB, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/API/products/createProduct", {
                            // send data to server
                            method: "POST",
                            headers: {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, response.json()];
                case 2:
                    _a = _b.sent(), error = _a.error, productDB = _a.productDB;
